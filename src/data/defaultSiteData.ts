export const defaultSiteData = {
  ...
  "whatsappMessages": {
    "booking": {
      "ro": "🎉 Salut! Vreau să rezerv o petrecere la Triple Fun! Vă rog să mă contactați pentru detalii. Mulțumesc!",
      "en": "🎉 Hello! I want to book a party at Triple Fun! Please contact me for details. Thank you!",
      "hu": "🎉 Szia! Szeretnék bulit foglalni a Triple Fun-ban! Kérlek vegyetek fel velem a kapcsolatot a részletekért. Köszönöm!"
    },
    "contact": {
      "ro": "📞 Salut! Am o întrebare despre Triple Fun. Vă rog să mă contactați. Mulțumesc!",
      "en": "📞 Hello! I have a question about Triple Fun. Please contact me. Thank you!",
      "hu": "📞 Szia! Kérdésem van a Triple Fun-nal kapcsolatban. Kérlek vegyetek fel velem a kapcsolatot. Köszönöm!"
    }
  },
  "schedule": {
