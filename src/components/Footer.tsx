        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Locul perfect pentru petreceri de copii și distracție în familie. 
              Creăm amintiri de neuitat într-un mediu sigur și prietenos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#home" className="text-gray-300 hover:text-white transition-colors">Acasă</a></li>
              <li><a href="#services" className="text-gray-300 hover:text-white transition-colors">Servicii</a></li>
              <li><a href="#menu" className="text-gray-300 hover:text-white transition-colors">Meniu</a></li>
              <li><a href="#pricing" className="text-gray-300 hover:text-white transition-colors">Prețuri</a></li>
              <li><a href="#offers" className="text-gray-300 hover:text-white transition-colors">Oferte</a></li>
              <li><a href="#gallery" className="text-gray-300 hover:text-white transition-colors">Galerie</a></li>
              <li><a href="#regulations" className="text-gray-300 hover:text-white transition-colors">Regulament</a></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-gray-300 text-sm flex items-center mt-4 md:mt-0">
              Făcut cu <Heart className="h-4 w-4 mx-1 text-red-500 fill-current" /> pentru copii
            </p>
          </div>
        </div>
      </div>
